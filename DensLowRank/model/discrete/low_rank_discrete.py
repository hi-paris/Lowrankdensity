...
# ### The Goal of this script is to optimise low rank estimation:
#
...
# ## II - generate_dirichlet_low_rank_samples <a class="anchor" id="third-bullet"></a>
...
# ## III - our_algo <a class="anchor" id="fourth-bullet"></a>
...
# ## IV - loss_calculation  <a class="anchor" id="fifth-bullet"></a>


def loss_calculation():
    '''
    The goal of this function is to evaluate the performance of the algorithm and show the efficiency achieved by the above function for discrete distributions.
    ...
    for (i, d) in enumerate(range(beg, end, step)):
        ...
        diric1 = d1 / (3 * K)
        diric2 = d2 / (3 * K)
        (P, Y1, Y2) = generate_dirichlet_low_rank_samples(
            d1, d2, K, n, diric1, diric2)
